/* ─────────────────────────────────────────────────────────────
   ...
   Usage:  <canvas data-dots="rain" data-accent="#6A86E5"></canvas>
...
(function () {
  ...
  function Dots(cv, mode, opts) {
    ...
    var accent = opts.accent || cssAccent('--art-accent-hi', '#AAA5EE');
    ...
    var MODES = {
      ...
      heat: function (dt) {
        ...
        for (var i = 0; i < pts.length; i++) {
          ...
          ctx.fillStyle = hex(up > 0.55 ? accent : cssAccent('--art-accent', '#6A86E5'), 0.06 + 0.34 * (1 - up));
