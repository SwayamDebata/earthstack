            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'clamp(1.5rem, 3vw, 2.5rem)' }}>
              {[
                ...
                <div key={col.t} className="me-panel" style={{ background: col.accent ? 'var(--surface)' : 'transparent', borderStyle: col.accent ? 'solid' : 'dashed' }}>
                  <p className="me-label" style={{ marginBottom: '1.25rem', color: col.accent ? 'var(--accent)' : 'var(--faint)' }}>
                    {col.t}
                  </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 'clamp(1.5rem, 3vw, 2.5rem)' }}>
              ...
              <div className="me-panel" style={{ background: 'var(--surface)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, marginBottom: 18 }}>
                  ...
                  <span className="me-label" style={{ color: 'var(--accent)' }}>Odia</span>
                </div>
                ...
                <span className="me-label" style={{ color: 'var(--accent)' }}>▶ Tap to hear</span>
              </div>
              ...
              <div className="me-panel" style={{ background: 'var(--surface)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18, flexWrap: 'wrap' }}>
                  ...
                  <span className="me-mono" style={{ fontSize: 12, color: 'var(--accent)', fontWeight: 500 }}>HIGH · 48 hours</span>
                </div>
              ...
              <div className="me-panel" style={{ background: 'var(--surface)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {[
                    ...
                    <div key={i} style={{ alignSelf: m.me ? 'flex-start' : 'flex-end', maxWidth: '90%', background: m.me ? 'color-mix(in srgb, var(--accent) 12%, transparent)' : 'var(--surface-2)', padding: '0.6rem 0.8rem', fontSize: 14, lineHeight: 1.5, color: 'var(--ink)' }}>
              ...
              <dl style={{ margin: 0 }}>
                {STANDS.map(([k, v]) => (
                  <div key={k} className="me-kv">
                    ...
                    <dd className="me-mono" style={{ margin: 0, fontSize: 12.5, color: v === 'Yes' ? 'var(--green)' : v === 'Not yet' ? 'var(--accent)' : 'var(--muted)' }}>
                      {v}
                    </dd>
                  </div>
                ))}
